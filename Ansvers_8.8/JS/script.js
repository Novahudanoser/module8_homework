...
async function loadImages() {
    try {
        ...
        console.error("Ошибка при загрузке изображений! Установите и запуститеVPN!:", error);
        alert("Произошла ошибка при загрузке изображений! Установите и запустите VPN!");
    } finally {
